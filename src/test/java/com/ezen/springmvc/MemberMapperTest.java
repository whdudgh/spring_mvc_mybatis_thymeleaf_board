...
//		String passwd = "1111";
	...
	@Test
	@Disabled
	public void findBySearchTypeTest() {
//		List<Member> list = memberMapper.findBySearchType("id", "bangry");
		List<Member> list = memberMapper.findBySearchType("name", "나");
		log.info("검색 타입별 검색 회원 전체목록 : {}", list);
	}
	
	@Test
	@Disabled
	public void findBySearchAllTest() {
//		List<Member> list = memberMapper.findBySearchAll("bangry");
		List<Member> list = memberMapper.findBySearchAll("나");
		log.info("모든 검색 전체목록 : {}", list);
	}
	
	@Test
//	@Disabled
	public void findBySearchAllOptionTest() {
